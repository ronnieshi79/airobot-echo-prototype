 ...
 */
function computeDynamicLiveSlices(params: ContextComputationParams): ServiceSlice[] {
  const {
    alarms,
    ringingAlarmId,
    isFocusRunning,
...
/**
 * Computes preset service slices for "deep_work" context
 */
...
/**
 * Computes preset service slices for "morning_wake" context
 */
...
/**
 * Computes preset service slices for "afternoon_break" context
 */
...
/**
 * Computes preset service slices for "evening_review" context
 */
...
/**
 * Computes preset service slices for "night_healing" context
 */
...
/**
 * Computes preset service slices for "active_energy" context
 */
...
/**
 * Master Context Engine Slicing Function
 * Combines dynamic runtime states and contextual presets into a prioritized queue of Service Slices.
 */
export function getContextServiceSlices(params: ContextComputationParams): ContextComputationResult {
  ...
  // Deduplicate slices by targetOverlay or id if already present in dynamic slices
