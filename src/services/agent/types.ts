...
export interface ServiceSlice {
  ...
  title: string;
  description: string;
  iconType: 'timer' | 'focus' | 'calendar' | 'podcast' | 'alarm' | 'logbook' | 'library';
  badge?: string;
  ...
  targetOverlay: 'focus' | 'timer' | 'alarm' | 'podcast' | 'logbook' | 'planner' | 'podcast_library' | 'calendar_flex';
...
export type CardOverlayType = 'focus' | 'timer' | 'alarm' | 'podcast' | 'logbook' | 'planner' | 'podcast_library' | 'calendar_flex' | null;
